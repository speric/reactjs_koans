...
class GroceryList extends React.Component {
  ...
  addGroceryItem() {
    const newGroceryName = this.state.newGroceryName;
    if (newGroceryName.length === 0) { return false; }
    this.setState({groceries: this.state.groceries.concat({ name: newGroceryName })});
  }
