...
class GroceryList extends React.Component {
  ...
  toggleGroceryCompleteness(groceryIndex) {
    const oldGroceryList = this.state.groceries;
    let newGroceryList = oldGroceryList;
    let newGroceryItem = oldGroceryList[groceryIndex];
    newGroceryItem.completed = true;
    newGroceryList.splice(groceryIndex, 1, newGroceryItem);
